...
产批次不同混合发货</h3>
				...
				<div class="des_position">
					...
					<div class="dl clearfix">
						...
						<div class="dd clearfix">
							<div class="des_item des_item_color des_item_active">
								白色
							</div>
							<div class="des_item des_item_color">
								黑色
							</div>
							<div class="des_item des_item_color">
								金黄色
				...
				<div class="des_select">
					已选择 <span class="des_color_selected">白色</span><span>|</span><span class="des_sm_selected">WIFI 16GB</span>
				</div>
				<div class="shop_buy">
					<a href="shopCar.php" class="shopping_btn"></a>
					<span class="line"></span>
					<a href="shopCar.php" class="buy_btn"></a>
				</div>
				<div class="notes">
